...
class NoTravel extends StatelessWidget {
  const NoTravel({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        Text('You have no Travel insurance!',
        ...
        SizedBox(height: 50,),
        Text('Get travel insurance before international departures',
        ...
        Container(
          ...
          child: ElevatedButton(onPressed: () => Navigator.of(context).pushNamed(TravelInsuranceApplicationForm.routeName),
